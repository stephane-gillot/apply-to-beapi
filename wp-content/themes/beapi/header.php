...
<head>
	...
	<link rel="apple-touch-icon-precomposed" sizes="57x57" href="<?php echo get_template_directory_uri() ?>/images/apple-touch-icon-57x57-precomposed.png">
	...
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri() ?>/css/magnific-popup.min.css"/>
